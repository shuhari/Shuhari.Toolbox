...
bool RarCommand::extract(const QString &rarPath, const QString &path, OverrideMode override)
{
    ...
    switch (override)
    {
    case OverrideMode::ASK: arguments << "-o"; break;
    case OverrideMode::OVERWRITE: arguments << "-o+"; break;
    case OverrideMode::SKIP: arguments << "-o-"; break;
    case OverrideMode::DONTCARE: break;
    }
